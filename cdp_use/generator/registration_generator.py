...
"""
    ...
    def generate_registration_class(self, domain_name: str, events: List[Dict[str, Any]]) -> str:
        """Generate the registration class for a domain."""
        class_name = f"{domain_name}Registration"
        
        # Import events
        self.type_checking_imports.add("from .events import *")
        self.type_checking_imports.add("from ..registry import EventRegistry")
        
        content = f"class {class_name}:\n"
        content += f'    """Event registration interface for {domain_name} domain."""\n\n'
    ...
    def generate_event_registration_method(self, event: Dict[str, Any], domain_name: str) -> str:
        """Generate a registration method for a single event."""
        event_name = event["name"]
        method_name = self.to_method_name(event_name)
    ...
    def to_method_name(self, name: str) -> str:
        """Convert a CDP name to a Python method name."""
