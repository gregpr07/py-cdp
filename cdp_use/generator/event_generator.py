...
"""
    ...
    def generate_event_type(
        ...
        """Generate Pydantic BaseModel for an event."""
        ...
        if not parameters:
            ...
            required_params = [p for p in parameters if not p.get("optional", False)]
            optional_params = [p for p in parameters if p.get("optional", False)]
