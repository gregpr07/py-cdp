...
if TYPE_CHECKING:
    ...
    from cdp_use.event_registry_library import EventRegistryLibrary
...
class CDPClient:
    def __init__(self, url: str):
        ...
        self.register: "EventRegistryLibrary" = EventRegistryLibrary()
        ...
        try:
            while True:
                ...
                # Handle event messages (without id, but with method)
                    ...
                    # Try to handle the event through the event registry
                    handled = self.register.handle_event(method, params, session_id)
                    if not handled:
