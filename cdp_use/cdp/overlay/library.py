...
class OverlayClient:
    ...
    async def getHighlightObjectForTest(
        ...
        from .commands import GetHighlightObjectForTestReturns as _GetHighlightObjectForTestReturns
        return _GetHighlightObjectForTestReturns.model_validate(raw_result)
    ...
    async def getGridHighlightObjectsForTest(
        ...
        from .commands import GetGridHighlightObjectsForTestReturns as _GetGridHighlightObjectsForTestReturns
        return _GetGridHighlightObjectsForTestReturns.model_validate(raw_result)
    ...
    async def getSourceOrderHighlightObjectForTest(
        ...
        from .commands import GetSourceOrderHighlightObjectForTestReturns as _GetSourceOrderHighlightObjectForTestReturns
        return _GetSourceOrderHighlightObjectForTestReturns.model_validate(raw_result)
